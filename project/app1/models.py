...
class Product(models.Model):
    ...
    delivery_time = models.CharField(max_length=20, blank=True)  # Add this field for time period
    is_active = models.BooleanField(default=True)  # Add this field to track product status
